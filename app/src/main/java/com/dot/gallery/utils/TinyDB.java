...
public class TinyDB {
   ...
   public List<FavouriteCard> getListObject(String key, Class<?> mClass){
        Gson gson = new Gson();
        ArrayList<String> objStrings = getListString(key);
    	ArrayList<FavouriteCard> objects =  new ArrayList<>();

    	for(String jObjString : objStrings){
            FavouriteCard value  = gson.fromJson(jObjString, (Type) mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, List<FavouriteCard> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
